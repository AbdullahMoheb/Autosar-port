 ...
 * File Name: Port.c
 *
 * Description: Source file for TIVA-C Microcontroller - Port Driver.
 *
...
void Port_Init(const Port_ConfigType* ConfigPtr)
{
    ...
    for(index = ZERO; index < PORT_CONFIGURED_PINS; index++)
    {
        ...
        {
            case  0: PortGpio_Ptr = (volatile uint32 *)GPIO_PORT_A_BASE_ADDRESS; /* PORTA Base Address */
             break;
            case  1: PortGpio_Ptr = (volatile uint32 *)GPIO_PORT_B_BASE_ADDRESS; /* PORTB Base Address */
             break;
            case  2: PortGpio_Ptr = (volatile uint32 *)GPIO_PORT_C_BASE_ADDRESS; /* PORTC Base Address */
             break;
            case  3: PortGpio_Ptr = (volatile uint32 *)GPIO_PORT_D_BASE_ADDRESS; /* PORTD Base Address */
             break;
            case  4: PortGpio_Ptr = (volatile uint32 *)GPIO_PORT_E_BASE_ADDRESS; /* PORTE Base Address */
             break;
            case  5: PortGpio_Ptr = (volatile uint32 *)GPIO_PORT_F_BASE_ADDRESS; /* PORTF Base Address */
             break;
        }
        ...
        if (Port_ConfigPtr->Pin[index].initial_mode == MODE_DIO)
        {
        ...
        else if (Port_ConfigPtr->Pin[index].initial_mode == MODE_ADC)
        {
        ...
        else if(Port_ConfigPtr->Pin[index].direction == INPUT)
        {
